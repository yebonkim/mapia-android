...
import com.mapia.sns.asne.core.SocialNetworkAsyncTask;
import com.mapia.sns.asne.core.SocialNetworkException;
import com.mapia.sns.asne.core.listener.OnCheckIsFriendCompleteListener;
...
//    private final String INSTAGRAM_CALLBACK_URL = "oauth://ASNE";
     ...
     * @return {@link com.mapia.sns.asne.core.AccessToken}
     */
    @Override
    public AccessToken getAccessToken() {
        return new com.mapia.sns.asne.core.AccessToken(
    ...
    /**
     * Request {@link com.mapia.sns.asne.core.AccessToken} of Instagram social network that you can get from onRequestAccessTokenCompleteListener
     * @param onRequestAccessTokenCompleteListener listener for {@link com.mapia.sns.asne.core.AccessToken} request
     */
    @Override
    public void requestAccessToken(OnRequestAccessTokenCompleteListener onRequestAccessTokenCompleteListener) {
        super.requestAccessToken(onRequestAccessTokenCompleteListener);
        ((OnRequestAccessTokenCompleteListener) mLocalListeners.get(REQUEST_ACCESS_TOKEN))
                .onRequestAccessTokenComplete(getID(), new com.mapia.sns.asne.core.AccessToken(
                        mSharedPreferences.getString(SAVE_STATE_KEY_OAUTH_TOKEN, null),
                        null
                ));
    }
    ...
    /**
     * Request user {@link com.mapia.sns.asne.instagram.InstagramPerson} by userId - detailed user data
     * @param userId id of Instagram user
     * @param onRequestDetailedSocialPersonCompleteListener listener for {@link com.mapia.sns.asne.instagram.InstagramPerson} request
     */
    @Override
     ...
     * @param bundle bundle containing information that should be shared(Bundle constants in {@link com.mapia.sns.asne.core.SocialNetwork})
