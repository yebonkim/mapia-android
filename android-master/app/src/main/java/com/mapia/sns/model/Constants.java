...
public class Constants {
    ...
    public static final int[] userPhoto = {R.drawable.twitter_user, 
    ...
    public static final int[] color = {R.color.twitter, R.color.google_plus,
            R.color.facebook, R.color.vk, R.color.ok, R.color.instagram};
    public static final int[] color_light = {R.color.twitter_light, R.color.google_plus_light,
